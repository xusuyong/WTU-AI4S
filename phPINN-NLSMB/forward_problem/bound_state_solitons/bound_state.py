...
EExact = (
    196
    * (
        784 * np.exp(T - (4 / 5 + 3 * I / 5) * X)
        + 784 * np.exp((2 * T) / 5 - (5 / 13 + 573 * I / 325) * X)
        + 36 * np.exp(-(129 / 65 + 573 * I / 325) * X + (12 * T) / 5)
        + 225 * np.exp(-(102 / 65 + 3 * I / 5) * X + (9 * T) / 5)
    )
    / (
        153664
        + 38416 * np.exp(2 * T - (8 * X) / 5)
        + 240100 * np.exp((4 * T) / 5 - (10 * X) / 13)
        + 2025 * np.exp((14 * T) / 5 - (154 * X) / 65)
        + 156800 * np.exp((7 * T) / 5 - (77 * X) / 65) * np.cos((378 * X) / 325)
    )
)
pExact = (
    -421213000320
    * (
        (23 / 95 + 11 * I / 95) * np.exp(-(129 / 65 + 573 * I / 325) * X + (12 * T) / 5)
        + (196 / 171 + 980 * I / 171)
        * np.exp((2 * T) / 5 - (5 / 13 + 573 * I / 325) * X)
        + (22 / 19 + I) * np.exp(-(102 / 65 + 3 * I / 5) * X + (9 * T) / 5)
        + (10192 / 4275 + 20384 * I / 4275) * np.exp(T - (4 / 5 + 3 * I / 5) * X)
    )
    * (
        (
            (9 / 7 + I) * np.cos((378 * X) / 325)
            + (-21 / 229 + 27 * I / 229) * np.sin((378 * X) / 325)
        )
        * np.exp((7 * T) / 5 - (77 * X) / 65)
        + (405 / 78547 + 3645 * I / 179536) * np.exp((14 * T) / 5 - (154 * X) / 65)
        + (525 / 229 + 875 * I / 916) * np.exp((4 * T) / 5 - (10 * X) / 13)
        + 364 / 229
        + (273 / 1145 + 364 * I / 1145) * np.exp(2 * T - (8 * X) / 5)
    )
    / (
        169
        * (
...
etaExact = (
    (-799052800000 * np.cos((756 * X) / 325) - 1672648006400)
    * np.exp((14 * T) / 5 - (154 * X) / 65)
    + (
        -1833592606720 * np.cos((378 * X) / 325)
        + 354189373440 * np.sin((378 * X) / 325)
    )
    * np.exp((7 * T) / 5 - (77 * X) / 65)
    + (
        -4589252192000 * np.cos((378 * X) / 325)
        + 237180384000 * np.sin((378 * X) / 325)
    )
    * np.exp((11 * T) / 5 - (127 * X) / 65)
    + (-734280350720 * np.cos((378 * X) / 325) - 37948861440 * np.sin((378 * X) / 325))
    * np.exp((17 * T) / 5 - (181 * X) / 65)
    + (-24163272000 * np.cos((378 * X) / 325) - 4667544000 * np.sin((378 * X) / 325))
    * np.exp((21 * T) / 5 - (231 * X) / 65)
    - 3747120650000 * np.exp((8 * T) / 5 - (20 * X) / 13)
    - 12641265000 * np.exp((18 * T) / 5 - (204 * X) / 65)
    - 8557164000 * np.exp((24 * T) / 5 - (258 * X) / 65)
    - 266540625 * np.exp((28 * T) / 5 - (308 * X) / 65)
    - 153482061824 * np.exp(2 * T - (8 * X) / 5)
    - 95926288640 * np.exp(4 * T - (16 * X) / 5)
    - 4058419904000 * np.exp((4 * T) / 5 - (10 * X) / 13)
    - 1534820618240
) / (
    65
    * (
...
def solution(XT):
    ...
    EExact = (
        196
        * (
            784 * exp(T - (4 / 5 + 3 * I / 5) * X)
            + 784 * exp((2 * T) / 5 - (5 / 13 + 573 * I / 325) * X)
            + 36 * exp(-(129 / 65 + 573 * I / 325) * X + (12 * T) / 5)
            + 225 * exp(-(102 / 65 + 3 * I / 5) * X + (9 * T) / 5)
        )
        / (
            153664
            + 38416 * exp(2 * T - (8 * X) / 5)
            + 240100 * exp((4 * T) / 5 - (10 * X) / 13)
            + 2025 * exp((14 * T) / 5 - (154 * X) / 65)
            + 156800 * exp((7 * T) / 5 - (77 * X) / 65) * cos((378 * X) / 325)
        )
    )
    pExact = (
        -421213000320
        * (
            (23 / 95 + 11 * I / 95)
            * exp(-(129 / 65 + 573 * I / 325) * X + (12 * T) / 5)
            + (196 / 171 + 980 * I / 171)
            * exp((2 * T) / 5 - (5 / 13 + 573 * I / 325) * X)
            + (22 / 19 + I) * exp(-(102 / 65 + 3 * I / 5) * X + (9 * T) / 5)
            + (10192 / 4275 + 20384 * I / 4275) * exp(T - (4 / 5 + 3 * I / 5) * X)
        )
        * (
            (
                (9 / 7 + I) * cos((378 * X) / 325)
                + (-21 / 229 + 27 * I / 229) * sin((378 * X) / 325)
            )
            * exp((7 * T) / 5 - (77 * X) / 65)
            + (405 / 78547 + 3645 * I / 179536) * exp((14 * T) / 5 - (154 * X) / 65)
            + (525 / 229 + 875 * I / 916) * exp((4 * T) / 5 - (10 * X) / 13)
            + 364 / 229
            + (273 / 1145 + 364 * I / 1145) * exp(2 * T - (8 * X) / 5)
        )
        / (
            169
            * (
    ...
    etaExact = (
        (-799052800000 * cos((756 * X) / 325) - 1672648006400)
        * exp((14 * T) / 5 - (154 * X) / 65)
        + (-1833592606720 * cos((378 * X) / 325) + 354189373440 * sin((378 * X) / 325))
        * exp((7 * T) / 5 - (77 * X) / 65)
        + (-4589252192000 * cos((378 * X) / 325) + 237180384000 * sin((378 * X) / 325))
        * exp((11 * T) / 5 - (127 * X) / 65)
        + (-734280350720 * np.cos((378 * X) / 325) - 37948861440 * sin((378 * X) / 325))
        * exp((17 * T) / 5 - (181 * X) / 65)
        + (-24163272000 * cos((378 * X) / 325) - 4667544000 * sin((378 * X) / 325))
        * exp((21 * T) / 5 - (231 * X) / 65)
        - 3747120650000 * exp((8 * T) / 5 - (20 * X) / 13)
        - 12641265000 * exp((18 * T) / 5 - (204 * X) / 65)
        - 8557164000 * exp((24 * T) / 5 - (258 * X) / 65)
        - 266540625 * exp((28 * T) / 5 - (308 * X) / 65)
        - 153482061824 * exp(2 * T - (8 * X) / 5)
        - 95926288640 * exp(4 * T - (16 * X) / 5)
        - 4058419904000 * exp((4 * T) / 5 - (10 * X) / 13)
        - 1534820618240
    ) / (
        65
        * (
...
def output_transform(XT, y):
    ...
    etaExact = (
        ...
        * exp((7 * T) / 5 - (77 * X) / 65)
        + (-4589252192000 * cos((378 * X) / 325) + 237180384000 * sin((378 * X) / 325))
        * exp((11 * T) / 5 - (127 * X) / 65)
        + (-734280350720 * cos((378 * X) / 325) - 37948861440 * sin((378 * X) / 325))
        * exp((17 * T) / 5 - (181 * X) / 65)
        + (-24163272000 * cos((378 * X) / 325) - 4667544000 * sin((378 * X) / 325))
        * exp((21 * T) / 5 - (231 * X) / 65)
        - 3747120650000 * exp((8 * T) / 5 - (20 * X) / 13)
