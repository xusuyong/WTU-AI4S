...
file3 = "3噪声/loss.dat"
file5 = "5噪声/loss.dat"
file10 = "10噪声/loss.dat"

fnamevar0 = "0噪声/variables1.dat"
fnamevar1 = "1噪声/variables1.dat"
fnamevar3 = "3噪声/variables1.dat"
fnamevar5 = "5噪声/variables1.dat"
fnamevar10 = "10噪声/variables1.dat"


data1 = scipy.io.loadmat("0噪声/反问题怪波0的噪声0.5,-1,0.5.mat")
true_a1 = 0.5
true_a2 = -1
true_o0 = 0.5
tt0 = -2
...
ax10.text(l - 6500, Chat[-1, 0] + 0.25, r"$\alpha_1$=%.5f" % Chat[-1, 0], fontsize=10)
plt.plot(l, Chat[-1, 1], "*", ms="10", c="#f23b27")
ax10.text(l - 6500, Chat[-1, 1] + 0.2, r"$\alpha_2$=%.5f" % Chat[-1, 1], fontsize=10)
plt.plot(l, Chat[-1, 2], "*", ms="10", c="#304f9e")
ax10.text(l - 6500, Chat[-1, 2] - 0.35, r"$\omega_0$=%.5f" % Chat[-1, 2], fontsize=10)
...
# plt.plot(l,Chat[-1,0],'*',ms='10',c='#e9963e');ax11.text(l-5000,Chat[-1,0]+0.25, r'$\alpha_1$=%.5f'%Chat[-1,0], fontsize=10)
# plt.plot(l,Chat[-1,1],'*',ms='10',c='#f23b27');ax11.text(l-5000,Chat[-1,1]+0.2, r'$\alpha_2$=%.5f'%Chat[-1,1], fontsize=10)
# plt.plot(l,Chat[-1,2],'*',ms='10',c='#304f9e');ax11.text(l-5000,Chat[-1,2]-0.35, r'$\omega_0$=%.5f'%Chat[-1,2], fontsize=10)
# # square0 = plt.Rectangle(xy=(0, 0.9), width=l, height=0.2, fc='#65a9d7', alpha=0.35)
# square1 = plt.Rectangle(xy=(0, 0.45), width=l, height=0.1,fc='#65a9d7', alpha=0.35)
# square2 = plt.Rectangle(xy=(0, -1.1), width=l, height=0.2,fc='#65a9d7', alpha=0.35)
...
# plt.plot(range(0, period * l, period), np.ones(Chat[:, 1].shape) * true_a2, "--",c='#f23b27',)
# plt.plot(range(0, period * l, period), np.ones(Chat[:, 2].shape) * true_o0, "--",c='#304f9e',)
# plt.plot(l,Chat[-1,0],'*',ms='10',c='#e9963e');ax20.text(l-5000,Chat[-1,0]+0.25, r'$\alpha_1$=%.5f'%Chat[-1,0], fontsize=10)
# plt.plot(l,Chat[-1,1],'*',ms='10',c='#f23b27');ax20.text(l-5000,Chat[-1,1]+0.2, r'$\alpha_2$=%.5f'%Chat[-1,1], fontsize=10)
# plt.plot(l,Chat[-1,2],'*',ms='10',c='#304f9e');ax20.text(l-5000,Chat[-1,2]-0.35, r'$\omega_0$=%.5f'%Chat[-1,2], fontsize=10)
# # square0 = plt.Rectangle(xy=(0, 0.9), width=l, height=0.2, fc='#65a9d7', alpha=0.35)
# square1 = plt.Rectangle(xy=(0, 0.45), width=l, height=0.1,fc='#65a9d7', alpha=0.35)
# square2 = plt.Rectangle(xy=(0, -1.1), width=l, height=0.2,fc='#65a9d7', alpha=0.35)
...
plt.plot(l, Chat[-1, 0], "*", ms="10", c="#e9963e")
ax21.text(l - 5000, Chat[-1, 0] + 0.25, r"$\alpha_1$=%.5f" % Chat[-1, 0], fontsize=10)
plt.plot(l, Chat[-1, 1], "*", ms="10", c="#f23b27")
ax21.text(l - 5000, Chat[-1, 1] + 0.2, r"$\alpha_2$=%.5f" % Chat[-1, 1], fontsize=10)
plt.plot(l, Chat[-1, 2], "*", ms="10", c="#304f9e")
ax21.text(l - 5000, Chat[-1, 2] - 0.35, r"$\omega_0$=%.5f" % Chat[-1, 2], fontsize=10)
# square0 = plt.Rectangle(xy=(0, 0.9), width=l, height=0.2, fc='#65a9d7', alpha=0.35)
square1 = plt.Rectangle(xy=(0, 0.45), width=l, height=0.1, fc="#65a9d7", alpha=0.35)
square2 = plt.Rectangle(xy=(0, -1.1), width=l, height=0.2, fc="#65a9d7", alpha=0.35)
...
plt.plot(l, Chat[-1, 0], "*", ms="10", c="#e9963e")
ax30.text(l - 5000, Chat[-1, 0] + 0.25, r"$\alpha_1$=%.5f" % Chat[-1, 0], fontsize=10)
plt.plot(l, Chat[-1, 1], "*", ms="10", c="#f23b27")
ax30.text(l - 5000, Chat[-1, 1] + 0.2, r"$\alpha_2$=%.5f" % Chat[-1, 1], fontsize=10)
plt.plot(l, Chat[-1, 2], "*", ms="10", c="#304f9e")
ax30.text(l - 5000, Chat[-1, 2] - 0.35, r"$\omega_0$=%.5f" % Chat[-1, 2], fontsize=10)
# square0 = plt.Rectangle(xy=(0, 0.9), width=l, height=0.2, fc='#65a9d7', alpha=0.35)
square1 = plt.Rectangle(xy=(0, 0.45), width=l, height=0.1, fc="#65a9d7", alpha=0.35)
square2 = plt.Rectangle(xy=(0, -1.1), width=l, height=0.2, fc="#65a9d7", alpha=0.35)
