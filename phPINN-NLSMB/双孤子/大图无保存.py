...
# %%
file0 = r"D:\QQwenjian\NLS-MBproject\dde\文献47双孤子\训练数据\loss.dat"
data1 = scipy.io.loadmat(
    r"D:\QQwenjian\NLS-MBproject\dde\文献47双孤子\训练数据\预测结果_双孤子etav0.mat"
)
tt0 = -3
tt1 = 3
x = data1["x"]
...
subfigs[0, 1].set_facecolor("0.95")
...
# %%第三个子图t=-2
subfigs[1, 0].set_facecolor("0.95")
...
# %%第五个子图Loss
subfigs[2, 0].set_facecolor("0.95")
...
# %%第六个子图Absolute error
subfigs[2, 1].set_facecolor("0.95")
